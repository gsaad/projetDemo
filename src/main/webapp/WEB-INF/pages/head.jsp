...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/media/css/demo_table.css" />
...
<script src="<%=request.getContextPath()%>/resources/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script src="<%=request.getContextPath()%>/resources/bootstrap-datepicker/js/bootstrap.file-input.js"></script>
