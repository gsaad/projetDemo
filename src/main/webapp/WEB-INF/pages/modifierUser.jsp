		...
		<div class="center span6 well">
			...
			<form method="POST" action="" accept-charset="UTF-8"
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="lastName" class="span3" name="lastName"
								placeholder="prenom" value ="${user.lastName}"/>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="firstName" class="span3" name="firstName"
								placeholder="nom" value ="${user.firstName}"/>
						</div>
					</div>
					<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="control-group">
						<label for="passwordverif" class="control-label"><fmt:message key="accueil.enregistrement.verifmotdepasse"/></label>
						<div class="controls">
						...
						<div class="controls">
							...
							<a onclick="document.location.href = '<%=request.getContextPath()%>/modifierUser/Cancel'">
